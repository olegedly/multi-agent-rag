...
source: https://millercenter.org/the-presidency/presidential-speeches/january-23-1980-state-union-address
description: >-
  The President outlines the challenges America faces in the world, highlighting
  the serious Soviet threat to other countries after its invasion of
  Afghanistan, and he warns that any attempt to take over the Persian Gulf
  region will be seen as a threat to the U.S. interests. Carter continues to
  maintain America's military strength, but he stresses the importance of his
  economic and energy policies to further improve the nation's defense.
---
