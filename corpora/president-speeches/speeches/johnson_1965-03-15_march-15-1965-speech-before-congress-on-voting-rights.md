...
source: https://millercenter.org/the-presidency/presidential-speeches/march-15-1965-speech-congress-voting-rights
description: >-
  Johnson states that every man should have the right to vote and that the civil
  rights problems challenge the entire country, not one region or group. The
  President asks Congress to help him pass legislation that dictates clear,
  uniform guidelines for voting regardless of race or ethnicity and that allows
  all citizens to register to vote free from harassment.
---
