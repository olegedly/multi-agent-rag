...
source: https://millercenter.org/the-presidency/presidential-speeches/january-29-2002-state-union-address
description: >-
  In his first State of the Union address, President George W. Bush focuses on
  the United States’ response to the September 11th events.  He credits the
  United States military with having suppressed terrorist activity in
  Afghanistan, yet he allows that many terrorist training camps still exist in
  other countries. Bush refers to Iraq Regime and terrorist cells as an “axis of
  evil” that poses a real danger to global peace. He asserts that if the U.S.
  were to look at the Iraq situation with indifference, the outcome would be
  “catastrophic.”
---
