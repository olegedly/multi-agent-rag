...
slug: articles/final-provisions/evaluation-and-review
source: https://en.ai-act.io/article/final-provisions/evaluation-and-review
prev:
  title: "Art. 111: AI systems already placed on the market or put into service and general-purpose AI models already placed on the marked"
  slug: article/final-provisions/ai-systems-already-placed-on-the-market-or-put-into-service-and-general-purpose-ai-models-already-placed-on-the-marked
next:
  title: "Art. 113: Entry into force and application"
  slug: article/final-provisions/entry-into-force-and-application
---
...
The Commission shall assess the need for amendment of the list set out in [Annex III](../../annexes/03-high-risk-ai-systems-referred-to-in-article-62.md) and of the list of prohibited AI practices laid down in [Article 5](../02-prohibited-ai-practices/005-prohibited-ai-practices.md), once a year following the entry into force of this Regulation, and until the end of the period of the delegation of power laid down in [Article 97](../11-delegation-of-power-and-committee-procedure/097-exercise-of-the-delegation.md). The Commission shall submit the findings of that assessment to the European Parliament and the Council.
...
(a) the need for amendments extending existing area headings or adding new area headings in [Annex III](../../annexes/03-high-risk-ai-systems-referred-to-in-article-62.md);
(b) amendments to the list of AI systems requiring additional transparency measures in [Article 50](../04-transparency-obligations-for-providers-and-deployers-of-certain-ai-systems/050-transparency-obligations-for-providers-and-deployers-of-certain-ai-systems.md);
...
(b) the state of penalties, in particular administrative fines as referred to in [Article 99](../12-penalties/099-penalties.md)(1), applied by Member States for infringements of this Regulation;
...
(a) the list set out in [Annex III](../../annexes/03-high-risk-ai-systems-referred-to-in-article-62.md), including the extension of existing area headings or the addition of new area headings in that Annex;
(b) the list of prohibited practices set out in [Article 5](../02-prohibited-ai-practices/005-prohibited-ai-practices.md); and
(c) the list of AI systems requiring additional transparency measures pursuant to [Article 50](../04-transparency-obligations-for-providers-and-deployers-of-certain-ai-systems/050-transparency-obligations-for-providers-and-deployers-of-certain-ai-systems.md).

###### (12)

Any amendment to this Regulation pursuant to paragraph 10, or relevant delegated or implementing acts, which concerns sectoral Union harmonisation legislation listed in Section B of [Annex I](../../annexes/01-list-of-union-harmonisation-legislation.md) shall take into account the regulatory specificities of each sector, and the existing governance, conformity assessment and enforcement mechanisms and authorities established therein.
