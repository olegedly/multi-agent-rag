...
section_num: 5
section_title: "Standards, conformity assessment, certificates, registration"
article_num: 41
article_title: 'Common specifications'
slug: articles/high-risk-ai-systems/standards-conformity-assessment-certificates-registration/common-specifications
source: https://en.ai-act.io/article/high-risk-ai-systems/standards-conformity-assessment-certificates-registration/common-specifications
prev:
  title: "Art. 40: Harmonised standards and standardisation deliverables"
  slug: article/high-risk-ai-systems/standards-conformity-assessment-certificates-registration/harmonised-standards-and-standardisation-deliverables
next:
  title: "Art. 42: Presumption of conformity with certain requirements"
  slug: article/high-risk-ai-systems/standards-conformity-assessment-certificates-registration/presumption-of-conformity-with-certain-requirements
related_recitals:
...
When drafting the common specifications, the Commission shall consult the advisory forum referred to in [Article 67](../../07-governance/01-governance-at-union-level/067-advisory-forum.md).
The implementing acts referred to in the first subparagraph of this paragraph shall be adopted in accordance with the examination procedure referred to in [Article 98](../../11-delegation-of-power-and-committee-procedure/098-committee-procedure.md)(2).

###### (2)

Before preparing a draft implementing act, the Commission shall inform the committee referred to in Art. 22 of Regulation (EU) No 1025/2012 that it considers the conditions laid down in paragraph 1 of this Article to be fulfilled.
