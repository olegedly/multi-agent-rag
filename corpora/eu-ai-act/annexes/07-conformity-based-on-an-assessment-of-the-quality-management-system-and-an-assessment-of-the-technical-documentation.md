...
slug: annexes/VII/conformity-based-on-an-assessment-of-the-quality-management-system-and-an-assessment-of-the-technical-documentation
source: https://en.ai-act.io/annex/VII/conformity-based-on-an-assessment-of-the-quality-management-system-and-an-assessment-of-the-technical-documentation
---
...
2.  Overview
    ...
    The approved quality management system for the design, development and testing of AI systems pursuant to [Article 17](../articles/03-high-risk-ai-systems/03-obligations-of-providers-and-deployers-of-high-risk-ai-systems-and-other-parties/017-quality-management-system.md) shall be examined in accordance with point 3 and shall be subject to surveillance as specified in point 5. The technical documentation of the AI system shall be examined in accordance with point 4.

3.  Quality management system

    3.1. The application of the provider shall include:

    1.  the name and address of the provider and, if the application is lodged by an authorised representative, also their name and address;
    ...
    4.  the documentation concerning the quality management system which shall cover all the aspects listed under [Article 17](../articles/03-high-risk-ai-systems/03-obligations-of-providers-and-deployers-of-high-risk-ai-systems-and-other-parties/017-quality-management-system.md);
    ...
    3.2. The quality management system shall be assessed by the notified body, which shall determine whether it satisfies the requirements referred to in [Article 17](../articles/03-high-risk-ai-systems/03-obligations-of-providers-and-deployers-of-high-risk-ai-systems-and-other-parties/017-quality-management-system.md).
...
4.  Control of the technical documentation
    ...
    3.  the technical documentation referred to in [Annex IV](04-technical-documentation-referred-to-in-article-111.md).
