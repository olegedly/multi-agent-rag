...
slug: articles/prohibited-ai-practices/prohibited-ai-practices
source: https://en.ai-act.io/article/prohibited-ai-practices/prohibited-ai-practices
prev:
  title: "Art. 4: AI literacy"
  slug: article/general-provisions/ai-literacy
next:
  title: "Art. 6: Classification rules for high-risk AI systems"
  slug: article/high-risk-ai-systems/classification-of-ai-systems-as-high-risk/classification-rules-for-high-risk-ai-systems
related_recitals:
  - title: "Recital 3: Establishing a uniform level of protection for AI in the EU"
    slug: recital/establishing-a-uniform-level-of-protection-for-ai-in-the-eu
  - title: "Recital 29: Influencing human behavior"
    slug: recital/influencing-human-behavior
  - title: "Recital 30: Use of AI for biometric categorization"
    slug: recital/use-of-ai-for-biometric-categorization
  - title: "Recital 31: Use of AI for social assessment"
    slug: recital/use-of-ai-for-social-assessment
  - title: "Recital 32: Use of AI for real-time remote identification"
    slug: recital/use-of-ai-for-real-time-remote-identification
  - title: "Recital 33: Use of biometric real-time remote identification systems for law enforcement purposes"
    slug: recital/use-of-biometric-real-time-remote-identification-systems-for-law-enforcement-purposes
  - title: "Recital 35: Authorization requirement"
    slug: recital/authorization-requirement
  - title: "Recital 36: Information of responsible authorities"
    slug: recital/information-of-responsible-authorities
  - title: "Recital 37: Adoption into national law"
    slug: recital/adoption-into-national-law
---
...
(III) the localisation or identification of a person suspected of having committed a criminal offence, for the purpose of conducting a criminal investigation or prosecution or executing a criminal penalty for offences referred to in [Annex II](../../annexes/02-list-of-criminal-offences-referred-to-in-article-51-first-subparagraph-point-hiii.md) and punishable in the Member State concerned by a custodial sentence or a detention order for a maximum period of at least four years.
Point (h) of the first subparagraph is without prejudice to Art. 9 of Regulation (EU) 2016/679 for the processing of biometric data for purposes other than law enforcement.
...
In addition, the use of ‘real-time’ remote biometric identification systems in publicly accessible spaces for the purposes of law enforcement for any of the objectives referred to in paragraph 1, first subparagraph, point (h), of this Article shall comply with necessary and proportionate safeguards and conditions in relation to the use in accordance with the national law authorising the use thereof, in particular as regards the temporal, geographic and personal limitations. The use of the ‘real-time’ remote biometric identification system in publicly accessible spaces shall be authorised only if the law enforcement authority has completed a fundamental rights impact assessment as provided for in [Article 27](../03-high-risk-ai-systems/03-obligations-of-providers-and-deployers-of-high-risk-ai-systems-and-other-parties/027-fundamental-rights-impact-assessment-for-high-risk-ai-systems.md) and has registered the system in the EU database according to [Article 49](../03-high-risk-ai-systems/05-standards-conformity-assessment-certificates-registration/049-registration.md). However, in duly justified cases of urgency, the use of such systems may be commenced without the registration in the EU database, provided that such registration is completed without undue delay.
